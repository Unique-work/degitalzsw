    ...
    <div align="center" style="width: 535px">
	 ...
	 <table>
	   <tr>
			...
			订单编号：<span style="font-size: 12px;color: blue;"></span>&nbsp;
			状态：<span style="font-size: 12px;color: blue;"></span>&nbsp;
			订单时间：<span style="font-size: 12px;color: blue;"></span>&nbsp;
			收货人：<span style="font-size: 12px;color: blue;"></span>&nbsp;
				<span style="font-size: 12px;color: red;">
				<a href="../OrderServlet?flag=receive&id=" onClick="if(confirm('确定要收货吗？')) return true;else return false;">确认收货</a>
				</span>
			</th>
	   </tr>
	 <tr>
		<td class="row" width="40%"></td>
		<td class="row" width="40%"><img src="" width="75" height="50" /></td>
