...
<area shape="rect" coords="769,145,797,168" href="../regist.html" alt="" />
	...
	<div id="pro_list1">
			...
			<div class="productslist">
				...
				<div><a href="product_detail.jsp?id="><img src="" width="170" height="128" /></a></div>
				<strong><br />
				经济高效，超低成本！<br /></strong>
		...
		<%
			...
			ArrayList<Product> pl= (ArrayList<Product>) pd.findAll();
			if(pl!=null){
				for (Product p:pl){
		%>
		<div class="productslist">
			...
			<div>
				<a href="product_detail.jsp?id=<%=p.getId()%>"><img src="<%=p.getPic()%>" width="170" height="128" /></a></div>
			</div>
		<div>
			<stron> <%=p.getName()%></stron><br />
			四叶草价：<span class="price">￥<%=p.getPrice()%></span><br />
			促销信息：<span class="onsale" >直降 ￥<%=(p.getPrice()-p.getSale())%></span >
		</div>
		<%}
		}%>
