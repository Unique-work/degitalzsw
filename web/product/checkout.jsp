...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN" xml:lang="zh-CN">
	...
	<div id="buycar">
	    ...
	    <div align="center" style="font-size: 20px;font-family: 黑体;text-shadow: blue;">订单信息</div>
		 <ul style="margin: 0 auto;">
			<li style="list-style: none;" class="text">用户名：</li>
			<li style="list-style: none;" class="text">配送地址：</li>
			<li style="list-style: none;" class="text">订单时间：</li>
		 </ul>
		</div>
		<div style="width: 530px;margin-left: 50px;margin-top: 0px" >
		 ...
		 <tr>
			<td class="row"><a href="product_detail.jsp?id="></a></td>
		 	<td class="row"></td>
			<td class="row"></td>		
		 </tr>
	...
	<p style="font-size: 18px;color: blue">合计：&nbsp; RMB</p>
