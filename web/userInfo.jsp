...
<area shape="rect" coords="769,145,797,168" href="<%=path %>/regist.html" alt="" />
	...
	<div id="pro_list1">
		  <form name="registform" id="registform" action="./UserServlet" method="post" >
				<table>
				  <tr>
					<th>账号：<%=u.getUserName()%></th>
					<td><input  type="text" name="userName" value="" size="20" maxlength="20" /></td>
				  </tr>
				  <tr>
					<th>积分：<%=u.getScore()%></th>
					<td><input  type="text" name="score" size="20" value="" /></td>
				  </tr>
				  <tr>
					<th>真实姓名：<%=u.getRealName()%></th>
					<td><input  type="text" name="realName" value="" size="20" maxlength="20" /></td>
				  </tr>
				  <tr>
					<th>用户性别：<%=u.getSex()%></th>
					<td>
				  ...
				  <tr>
					<th>配送地址：</th>
					<td><input  type="text" name="address"  size="20" value="" maxlength="20" /></td>
				  </tr>
				  <tr>
			 ...
			 ,"您手机号码的后6位是？","您父亲的姓名是？","您母亲的姓名是？"}; %>
				  ...
				  <tr>
					<th>答案：</th>
					<td><input  type="text" name="answer" value="" size="20" maxlength="20" /></td>
				  </tr>
				  <tr>
					<th>邮箱：</th>
